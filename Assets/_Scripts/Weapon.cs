...
//	in the Inspector pane. It doesnt work for everything, but it
//	will work for simple classes like this!
[System.Serializable]
public class WeaponDefinition {
	public WeaponType	type = WeaponType.none;
	public string		letter;			//the letter to show on the powerup
...
public class Weapon : MonoBehaviour {
	...
	void Start() {
		//Call SetType() properly for the dfault _type
		SetType (_type);
